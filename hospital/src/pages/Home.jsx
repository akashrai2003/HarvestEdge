...
import img1 from "../assets/images/scientist.jpg";
import img2 from "../assets/images/pest.jpg";
import img3 from "../assets/images/policy.jpg";
...
// import image from "../assets/images/tractor.jpeg";
						...
						<div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
							<div>
								<div className="lg:w-[570px]">
									<h1 className={`text-[36px] ${t==='kn'? "text-[35px]":"leading-[26px]"} text-white font-[800] md:text-[36px] md:leading-[70px]`}>
										{t("Welcome")}
									</h1>
									<p className="text_para font-bold text-white">{t("greeting")}</p>
									<button className="btn bg-green-600"> {t("Button1")}</button>
								</div>
								...
								<div className="mt-[30px] lg:mt-[30px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]">
									<div>
										...
										<p className="text_para text-white ">{t("Lang")}</p>
									</div>
									...
									<div>
										...
										<p className="text_para text-white">{t("Loca")}</p>
									</div>
									...
									<div>
										...
										<p className="text_para text-white">{t("Sat")}</p>
									</div>
								</div>
							</div>
						</div>
